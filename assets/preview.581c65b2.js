import{s as a}from"./index.4f6a610c.js";var n="storybook/highlight",d="storybookHighlight",_=`${n}/add`,g=`${n}/reset`;const{addons:E}=__STORYBOOK_MODULE_PREVIEW_API__,{STORY_CHANGED:H}=__STORYBOOK_MODULE_CORE_EVENTS__;var{document:h}=a,O=(e="#FF4785",t="dashed")=>`
  outline: 2px ${t} ${e};
  outline-offset: 2px;
...
//# sourceMappingURL=preview.581c65b2.js.map
